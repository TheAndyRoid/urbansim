...
setwd("/home/andyroid/uni/cs4526/Application/test/scale/data/chart")
...
setwd("/home/andyroid/uni/cs4526/Application/test/scale")
...
legend(x=120,y=100,legend=c("% Satisfied Devices","Bandwidth"),lty=c(1,1),col=c("red","blue"))
